...
class CustomMongoStore {
    ...
    async save(options) {
        ...
        // FIX: Look in .wwebjs_auth directory if it exists, otherwise root
        const zipPath = fs.existsSync(`./.wwebjs_auth/${options.session}.zip`) 
    ...
    async extract(options) {
        ...
        const outPath = options.path || `${options.session}.zip`;
